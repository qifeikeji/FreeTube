...
/** @typedef {{ _id: string, name: string, externalPlayerSettings?: { player?: string, executable?: string, ignoreWarnings?: boolean, ignoreDefaultArgs?: boolean, customArgs?: string[], openVideosOnClick?: boolean } }} Profile */
