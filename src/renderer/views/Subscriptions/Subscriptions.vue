...
/**
 * @param {'videos' | 'shorts' | 'live' | 'community' | string} tab
 */
function changeTab(tab) {
  ...
  if (visibleTabs.value.includes(/** @type {'videos' | 'shorts' | 'live' | 'community'} */ (tab))) {
    currentTab.value = /** @type {'videos' | 'shorts' | 'live' | 'community'} */ (tab)
  } else {
